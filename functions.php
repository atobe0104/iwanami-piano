...
function _tk_scripts() {
	...
	//layoutcssを読み込み
	wp_enqueue_style( '_iwanamipiano', get_template_directory_uri() . '/css/layout.min.css' );
...
//プラグインの追加
if (!class_exists('Acf') && !(in_array(@$_GET['action'], array('activate', 'upgrade-plugin')) && @$_GET['plugin'] == 'advanced-custom-fields/acf.php')) {
  define('ACF_LITE', false);
  require_once (dirname(__FILE__) . '/plugins/advanced-custom-fields/acf.php');
  add_action('acf/register_fields', function() {
    require_once (dirname(__FILE__) . '/plugins/acf-repeater/repeater.php');
    require_once (dirname(__FILE__) . '/plugins/acf-gallery/gallery.php');
  });
}
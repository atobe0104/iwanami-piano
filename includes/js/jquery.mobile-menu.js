...
;(function(mobileApp,$){
  ...
  MobileMenu.prototype = {
    ...
    setLayout: function(){
      ...
      $('#build-menu').append('<div class="build-menu-close-wrap"><div id="build-menu-close-btn"></div></div>');
      $('#menu-mobile-menu > li:last-child').after('<li class="change_langage-sp"><a href="#">日本語</a></li>');
      ...
      $("#build-menu-button, #build-menu-overlay , #build-menu-close-btn").on("click", function(e){
        e.preventDefault();
        var html = $("html");
